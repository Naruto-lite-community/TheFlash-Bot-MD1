...
> ˼🤖˹↜ الــبــوت↶
╮───────────────────⟢ـ
┆⚙️ ↜اسـم الـبـوت↶﹝𝑻𝑬𝑹𝑩𝑶 𝑩𝑶𝑻﹞
┆🪄 ↜الـمـطـور ↶﹝𝑻𝑬𝑹𝑩𝑶﹞
┆📌 ↜الـتـشـغـيـل ↶﹝${uptime}﹞
┆🔖 ↜الــمــســتـخـدمـيـن ↶﹝${rtotalreg}﹞
╯───────────────────⟢ـ
> © 𝑻𝑬𝑹𝑩𝑶 𝑩𝑶𝑻 𝑴𝑫`,subtitle: "Araab Zack",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: zack } }, { upload: conn.waUploadToServer }, {quoted: m}))},
                    contextInfo: {
                                    ...
                                    sections: [
                                        {
                                            ...
                                            highlight_label: 'بعبص بࢪآح ــتك',
                                            rows: [
                                                {
